...
- Bump Node.js dev dependencies: `@biomejs/biome` ^2.5.5 → ^2.5.10, `@napi-rs/cli` ^3.7.4 → ^3.8.6, `@types/node` ^25.9.5 → ^26.3.0, `@vitest/coverage-v8`/`vitest` ^4.1.10 → ^4.1.11, `typescript` ^6.0.3 → ^7.0.2
- Refresh `python/uv.lock` to pick up latest compatible dev dependency versions
